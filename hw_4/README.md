...
2. _Планирование запроса_: В зависимости от типа запроса и структуры данных, Weaviate планирует процесс выполнения запроса, определяет какие данные и какие индексы нужно использовать для выполнения запроса.
