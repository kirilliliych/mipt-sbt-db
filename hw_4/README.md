...
## Есть ли для вашей СУБД понятие "план запросов"? Если да, то объясните, как работает данный этап.
...
В документации к Weaviate не особо чего удалось найти :( Тем не менее, вот некоторые идеи:
...
## Какие методы защиты поддерживаются Weaviate? Шифрование трафика, модели авторизации и т.п.
1. _Шифрование трафика_: Weaviate поддерживает шифрование трафика с использованием протоколов безопасности, таких как SSL/TLS. Это обеспечивает защиту данных в процессе их передачи между клиентом и сервером;

2. _Модели авторизации_: Weaviate позволяет настраивать различные уровни авторизации и доступа к данным с использованием различных моделей аутентификации, таких как JWT, OAuth,
API key, OIDC (OpenID Connect) ([по ссылке](https://weaviate.io/developers/weaviate/configuration/authentication) примеры вариантов аутентиикации). Это позволяет установить гибкие правила доступа к данным для различных пользователей или групп пользователей;

3. _Ролевая модель доступа_: Weaviate поддерживает ролевую модель доступа, что означает, что различные пользователи могут иметь разные права доступа к данным в соответствии с их уровнем авторизации, что дает возможность управлять доступом к данным на более гранулярном уровне.

Также в разделе Security [упоминаются](https://weaviate.io/security) защищенное развертывание, шифрование end-to-end,
пользовательская аутентификация, встроенный режим коллективной аренды, автоматическое резервное копирование,
активный мониторинг, зоны множественной доступности.

## Какие сообщества развивают Weaviate? Кто в проекте имеет права на коммит и создание дистрибутива версий? Расскажите об этих людях/компаниях.
Weaviate - [опенсорсный проект](https://github.com/weaviate/weaviate).

Право на коммит имеют все, кто "имеет базовые навыки Golang" (по [ссылке](https://github.com/weaviate/weaviate/blob/main/CONTRIBUTING.md)
гайд для контрибьюторов). Ключевые контрибьюторы и разработчики:
- [Этьен Дилокер](https://github.com/etiennedi) - Co-Founder и CTO;
- [Боб ван Луижт](https://github.com/bobvanluijt) - Co-Founder и CEO;
- [Марцин Антас](https://github.com/antas-marcin) - Core Engineer;
- [Дирк Кулавьяк](https://github.com/dirkkul) - Core Engineer;
- [Анджей Лизка](https://github.com/aliszka) - Core Engineer;
- [Паркер Дакворт](https://github.com/parkerduckworth) - Core Engineer.
